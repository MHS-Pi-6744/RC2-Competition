    ...
    static {
      ...
      climbConfig
          ...
          .positionConversionFactor(
              ClimbSubsystemConstants.ClimbSetPoints.kPositionConversionFactor)
          .velocityConversionFactor(
              ClimbSubsystemConstants.ClimbSetPoints.kVelocityConversionFactor);
      climbConfig
          .closedLoop
          .feedbackSensor(FeedbackSensor.kPrimaryEncoder)
          .pid(
              ClimbSubsystemConstants.ClimbSetPoints.kP,
              ClimbSubsystemConstants.ClimbSetPoints.kI,
              ClimbSubsystemConstants.ClimbSetPoints.kD)
          .outputRange(-1, 1)
          .maxMotion
